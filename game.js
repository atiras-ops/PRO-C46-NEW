class Game{
    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 20 === 0) {
                     star = createSprite(random(100, 1000), 0, 100, 100);
                     stars.velocityY = 6;
                     var rand = Math.round(random(1,5));
                     switch(rand){
                         case 1: stars.addImage("star1",star1_img);
                         break;
                         case 2: stars.addImage("star1", star2_img);
                         break;
                         case 3: stars.addImage("star1", star3_img);
                         break;
                         case 4: stars.addImage("star1", star4_img);
                         break;
                         case 5: stars.addImage("star1", star5_img);
                         break;
                     }
                     starGroup.add(stars);
